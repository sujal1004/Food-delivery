...
export default function Home() {
    ...
    const loadData = async () => {
        ...
        // console.log(response[0], response[1]); // will print the whole data in consle directly , issi ko destructure krna 
                    ...
                    <div id="carouselExampleFade" className="carousel slide carousel-fade" data-bs-ride="carousel" style={{ objectFit: "contain !important" }}>
                        <div className="carousel-inner" id='carousel' style={{ maxHeight: " 500px" }}>
                            ...
                            <div className="carousel-item active">
                                <img src="https://source.unsplash.com/random/300×300/?biryani" className="d-block w-100" style={{ filter: "brightness(30%)" }} alt="..." />
                            </div>
                                ...
                                <div className='row mb-3 g-1 '>
                                    ...
                                    {foodItem !== []
                                        ...
                                        foodItem.filter((item) => (item.CategoryName === data.CategoryName) && (item.name.toLowerCase().includes(search.toLocaleLowerCase())))
                                            .map(filterItems => {
                                                return (
                                                    <div key={filterItems._id} className='col-12col-md-6 col-lg-4'>
